...
const I18N = {
  vi: {
    ...
    pctVsLy: "% So với năm trước",
    unitVnd: "VND (triệu / tỷ)",
    unitMil: "triệu",
    unitBil: "tỷ",
    perfOverTarget: "Thực hiện / Chỉ tiêu",
    yoyDefault: "Tăng trưởng so với cùng kỳ",
    lyNote: "Chưa có dữ liệu cùng kỳ",
    na: "Không có",
    ...
    axisVnd: "Tỷ / Triệu VND",
    axisPerfVnd: "Thực hiện (tỷ / triệu VND)",
    tooltipShare: "Tỷ trọng",
    tooltipPctAch: "% Đạt",
    tooltipLy: "Cùng kỳ LY",
  },
  en: {
    ...
    pctVsLy: "% vs Prior Year",
    unitVnd: "VND (mil / bil)",
    unitMil: "mil",
    unitBil: "bil",
    perfOverTarget: "Performance/Target",
    yoyDefault: "YoY growth",
    lyNote: "No prior-year data available",
    na: "N/A",
    ...
    axisVnd: "Bil / Mil VND",
    axisPerfVnd: "Performance (bil / mil VND)",
    tooltipShare: "Share",
    tooltipPctAch: "% Ach.",
    tooltipLy: "LY",
  },
